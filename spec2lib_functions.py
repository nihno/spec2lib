...
def save_jcamp(x,y,xraw,yraw,name,processing):
    ...
    if FLAG:
        ...
        ax2.set_title('Processed Data',fontsize=9,fontweight='bold',loc='left',fontstyle='italic')
